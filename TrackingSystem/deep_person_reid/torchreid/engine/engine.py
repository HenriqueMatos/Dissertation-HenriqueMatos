...
class Engine(object):
    ...
    def test(
        ...
        for name in targets:
            ...
            rank1, mAP, IDsObjectList = self._evaluate(
                dataset_name=name,
    ...
    def _evaluate(
        ...
        # print(distmat,distmat_gg,distmat_qq)
        ...
        if visrank:
            IDsObjectList = visualize_ranked_results(
                distmat,
        ...
        return cmc[0], mAP, IDsObjectList
